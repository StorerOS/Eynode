  ...
  <div class="app-header">
    <div class="app-header__content">
      ...
      <div class="right-container">
        <el-button v-if="token" type="primary" class="special-button" @click="toDashboard">DASHBOARD</el-button>
        <el-button v-else type="primary" class="special-button" @click="toLogin">SIGN IN</el-button>
      </div>
    </div>
  </div>
</template>
